...
namespace MyBlog.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                ConnectionString = this.Configuration["SqlConnection"],
    ...
    public static class IOCExtend
    {
        ...
        {
            services.AddScoped<IBlogNewsRespository, BlogNewsRespository>();
            services.AddScoped<IBlogNewsService, BlogNewsService>();

            services.AddScoped<ITypeInfoRespository, TypeInfoRespository>();
            services.AddScoped<ITypeInfoService, TypeInfoService>();

            services.AddScoped<IWriterInfoRespository, WriterInfoRespository>();
